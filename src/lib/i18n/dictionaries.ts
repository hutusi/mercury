...
const zh = {
  ...
  auth: {
    ...
    verifyTitle: "验证邮箱",
    verifySentTo: "如果该邮箱可完成注册，验证邮件已发送至",
    verifySpamHint: "点击邮件中的链接完成验证；没收到请查看垃圾邮件",
    resendEmail: "重新发送验证邮件",
    emailResent: "已重新发送，请查收",
    changeEmail: "返回修改邮箱",
    verifiedGoLogin: "已完成验证？直接前往登录",
    emailNotVerified: "邮箱尚未验证，我们刚发送了一封新的验证邮件",
    emailNotVerifiedResend: "邮箱尚未验证，请点击下方按钮重新发送验证邮件",
...
const en: Dictionary = {
  ...
  auth: {
    ...
    verifySentTo: "If this address can be registered, we sent a verification link to",
    verifySpamHint: "Click the link in the email to finish; check spam if it's missing",
    resendEmail: "Resend verification email",
    emailResent: "Sent — check your inbox",
    changeEmail: "Use a different email",
    verifiedGoLogin: "Already verified? Head to sign-in",
    emailNotVerified: "Email not verified — we just sent you a fresh link",
    emailNotVerifiedResend: "Email not verified — use the button below to resend the link",
