...
- [docs/adr/](docs/adr/) — decision records (Bun+Node split, SQLite+Drizzle, SM-2, homegrown i18n, server-issued deadlines, AI degradation, Postgres/Neon for serverless, versioned migrations, YAML content authoring, HTTP API v1 + bearer auth, multi-provider AI, learner model + AI memory, tutor chat)
