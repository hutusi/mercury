...
-- CREATE INDEX CONCURRENTLY path (build concurrently, then record the
-- migration as applied) — CONCURRENTLY cannot run inside a transaction, and
-- drizzle applies migrations in one.
